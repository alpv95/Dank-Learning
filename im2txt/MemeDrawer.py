...
#import sys
#sys.path.insert(0, '~/Desktop/Stanford/CS224n/MemeProject/memes')
...
images_TA = ['TimShi.jpg']
TEXT1_TA = ["is this a meme"]
TEXT2_TA = ["or a girl?"]
...
for i,ting in enumerate(images_TA):
    ...
    font = 'impact.ttf'
    img = ImageText('TAs/'+ images_TA[i]) #background=(255, 255, 255, 200)) # 200 = alpha
    ...
    img.write_text_box((2, 0), text1, box_width=img.size[0]+2, font_filename=font,
                       font_size=36, color=(0,0,0), place='center')
    img.write_text_box((-2, 0), text1, box_width=img.size[0]+2, font_filename=font,
                       font_size=36, color=(0,0,0), place='center')
    ...
    img.write_text_box((0, 0), text1, box_width=img.size[0]+2, font_filename=font,
                       font_size=36, color=color, place='center')

    img.write_text_box((-2, 255), text2, box_width=img.size[0]+2, font_filename=font,
                       font_size=36, color=(0,0,0), place='center',bottom=True)
    img.write_text_box((2, 255), text2, box_width=img.size[0]+2, font_filename=font,
                       font_size=36, color=(0,0,0), place='center',bottom=True)
    ...
    img.write_text_box((0, 255), text2, box_width=img.size[0]+2, font_filename=font,
                       font_size=36, color=color, place='center',bottom=True)
